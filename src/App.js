...
//           </tr>
//         </thead>
//         <Table name='Timilehin' age={20} phone={8071116477}/>
//         <Table name='Mark' age={10} phone={90647847477}/>
//         <Table name='John' age={100} phone={8071116477}/>
//       </table>
//     </div>
//   )
// }
...
export default function App() {
  return (
    <div className='text-center mx-auto lg:w-[40%] sm:w-[80%] mt-6 p-4 rounded-lg shadow-xl'>
      <Text />
      <Skills />
    </div>
  )
